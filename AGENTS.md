...
This file provides guidance to AI coding agents (OpenCode, Codex CLI, Codex App, Factory Droid, GitHub Copilot CLI, GitHub Copilot) when working with code in this repository.
